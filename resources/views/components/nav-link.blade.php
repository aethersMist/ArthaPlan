...
$classes = ($active ?? false)
            ? 'flex items-center justify-center px-4 py-2 text-light font-semibold bg-accent rounded-lg hover:bg-primary focus:outline-none focus:border-primary transition duration-150 ease-in-out'
