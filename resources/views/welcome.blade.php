        ...
        <main>
            ...
            <section class="p-6 bg-primary-dark" id="tentang">
                <div class="items-center max-w-screen-xl gap-16 px-4 py-8 mx-auto lg:grid lg:grid-cols-2 lg:py-16 lg:px-6" >
                    ...
                    <img src="{{ asset('assets/images/image.png') }}" alt="Foto Profil" class="w-full mt-4 rounded-lg lg:mt-10">
                    </div>
                </div>
            </section>
                        ...
                        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3"  >
                            <div>
                                ...
                                <ul class="text-netral">
                                    <li class="mb-4"><a href="https://laravel.com" class="hover:underline">Laravel Blade</a></li>
                                    <li class="mb-4"><a href="https://flowbite.com" class="hover:underline">Flowbite</a></li>
                                    <li class="mb-4"><a href="https://tailwindcss.com/" class="hover:underline">Tailwind CSS</a></li>
                                    <li class="mb-4"><a href="https://www.chartjs.org/docs/latest/" class="hover:underline">ChartJS</a></li>
                                    <li class="mb-4"><a href="https://www.apexcharts.com/" class="hover:underline">ApexCharts</a></li>
                                    <li class="mb-4"><a href="https://fontawesome.com/" class="hover:underline">Font Awesome</a></li>
                                </ul>
                            </div>
                            <div>
