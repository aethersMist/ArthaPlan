    ...
    <section class="min-h-screen flex flex-col justify-between px-6">
      <div class="flex-grow flex items-center justify-center">
        <div class="text-center">
          <h1 class="text-5xl font-bold text-primary-dark mb-4">429</h1>
          <h2 class="text-2xl font-semibold text-accent mb-2">
            Terlalu Banyak Permintaan
          </h2>
          <p class="text-md text-dark mb-6">
            Maaf, Anda telah melakukan terlalu banyak permintaan dalam waktu singkat. Silakan coba lagi nanti.
          </p>
          <a href="{{ url('/') }}"
